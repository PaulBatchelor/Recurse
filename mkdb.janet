...
(ww-add-page "tasks/react_describing_ui" `@!(logparse/render-logs-from-tag (ww-db) "react-describing-ui")!@`)
...
(ww-add-page "taskgroups/gamejam" `@!(logparse/render-tasks-from-group (ww-db) "gamejam")!@`)
