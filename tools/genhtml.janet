...
(defn generate [data-filepath &opt webroot]
  ...
  (defn generate-file-range-link [nd]
    (def frdata (nd "file_ranges"))
    (def pgname (string "dzf/" (frdata "filename")))
    (string
      (frdata "filename")
      ":"
      "<a href=\""
      webroot "/" pgname "#L" (frdata "start") "\">"
      (frdata "start")
      "</a>"
      (if-not
        (< (frdata "end") 0)
  ...
  (defn generate-comments [comments]
    (each cmt comments
      ...
      (print "</p>")
      (if (and (cmt "comment") (> (length (cmt "comment")) 0))
          (org (cmt "comment")))))
